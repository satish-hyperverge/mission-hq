...
export default function TeamBreakdown({ employees, dates, selectedTeam, selectedDate }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 p-5">
      <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Team Status View</h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b dark:border-slate-700 bg-gray-50 dark:bg-slate-800">
              ...
              <th className="text-left py-2 px-3 font-medium text-gray-600 dark:text-gray-300 min-w-[120px]">Team</th>
              {pastDates.map((d) => (
